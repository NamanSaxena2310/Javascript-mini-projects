document.addEventListener("DOMContentLoaded", function() {
    ...
    function generateTransactionRow(transaction, index) {
        const tableBody = document.getElementById("transaction_body");
        ...
        row.querySelector(".delete_btn").addEventListener("click", function() {
    ...
    function updateChart() {
        ...
        const ctx = document.getElementById('income_expenses_chart').getContext('2d');
